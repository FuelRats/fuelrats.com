...
- [#465](https://github.com/FuelRats/fuelrats.com/pull/465) [`c613dbc`](https://github.com/FuelRats/fuelrats.com/commit/c613dbc80185425ce9ef36bab0100ad3d509d045) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - Major modernization of the Fuel Rats website with new features, infrastructure overhaul, and comprehensive quality improvements.
...
- [#470](https://github.com/FuelRats/fuelrats.com/pull/470) [`aa44739`](https://github.com/FuelRats/fuelrats.com/commit/aa447395e5b438b6be93fcf5bfd4d071c8106b09) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Added
  - A "Send test notification" button in the push-notification settings. When push is enabled on a device, you can send yourself a test notification to confirm delivery is working on your subscribed devices.

### Patch Changes

- [`452279c`](https://github.com/FuelRats/fuelrats.com/commit/452279cd748dee7fa2d2ace96a245edee58d7965) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Fixed

  - Page header decorative stripes no longer bleed through on white-background pages
  - Removed redundant breadcrumbs from profile page (tab bar already handles navigation)
  - Code Red background on profile rescues list now correctly overrides alternating row stripes
  - EDSM link now uses search URL that properly redirects to the system page
  - Sound notifications no longer fire on initial page load
  - Sound notifications now detect all rescue attribute changes including quotes, notes, carrier, outcome, expansion, title, and language
  - Fleet carrier icon moved from first rat row to rescue header next to platform badge

  ### Changed

  - Odyssey badge color changed from mustard yellow to orange to match MechaSqueak
  - Rescue detail header title area uses flexbox for consistent alignment of badges and icons

- [#472](https://github.com/FuelRats/fuelrats.com/pull/472) [`2f03faf`](https://github.com/FuelRats/fuelrats.com/commit/2f03faf07c861476e757345255271cc0133f5363) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Fixed

  - Avatar uploads that are rejected by the server as too large (HTTP 413) now show a clear "avatar is too large" message instead of a generic internal-server error telling you to contact support.

- [#471](https://github.com/FuelRats/fuelrats.com/pull/471) [`23a2a12`](https://github.com/FuelRats/fuelrats.com/commit/23a2a12ec58a680d7ca582c6528d09ca19c8cbc3) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Fixed
...
- [#467](https://github.com/FuelRats/fuelrats.com/pull/467) [`662a621`](https://github.com/FuelRats/fuelrats.com/commit/662a6218698e0e9b1ad25a258be44dbc368598ad) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Fixed
...
- [#473](https://github.com/FuelRats/fuelrats.com/pull/473) [`185ad08`](https://github.com/FuelRats/fuelrats.com/commit/185ad08d25b9b26d3b6b05f220e29f86668a9509) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Fixed

  - On the dispatch board, the floating user-menu avatar no longer overlaps the notification and board-settings buttons when the site is installed as a home-screen app (standalone PWA, e.g. on iOS).

- [#476](https://github.com/FuelRats/fuelrats.com/pull/476) [`0f019a0`](https://github.com/FuelRats/fuelrats.com/commit/0f019a04e9ada1e922feb88be1c086de515aa7a2) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Changed

  - On the dispatch board, the tooltip showing a quote's exact timestamp can now be reached anywhere in the time column of that quote, instead of only on the few pixels the relative time ("3 hours ago") itself covers.

- [#475](https://github.com/FuelRats/fuelrats.com/pull/475) [`938a031`](https://github.com/FuelRats/fuelrats.com/commit/938a031504682288cf969f8b753c02e29e71b6ce) Thanks [@SuperManifolds](https://github.com/SuperManifolds)! - ### Fixed
  - Correcting a rescue's star system in paperwork now actually registers. Clearing the field and entering a new system — by typing it or picking it from the suggestions — left "Must have a star system location." on screen and the Submit button hidden, even though the new system was shown in the field. The same fault silently emptied the assigned rats and dispatcher fields when they were edited.
  - The star system field is now correctly labelled for screen readers.

## 2.17.1

### Patch Changes

- [#442](https://github.com/FuelRats/fuelrats.com/pull/442) [`756213b`](https://github.com/FuelRats/fuelrats.com/commit/756213bcccf3672403f6d87fb1cb9e0d59ceeba1) Thanks [@evertiro](https://github.com/evertiro)! - Adjusted profile decal table header for clarity

- [#438](https://github.com/FuelRats/fuelrats.com/pull/438) [`66b0ca4`](https://github.com/FuelRats/fuelrats.com/commit/66b0ca4b659f1d99fa5134be9599f8f54bf3fe22) Thanks [@UncleClapton](https://github.com/UncleClapton)! - Add changesets for changelog management!

- [#443](https://github.com/FuelRats/fuelrats.com/pull/443) [`162ff89`](https://github.com/FuelRats/fuelrats.com/commit/162ff89ddc3cb71fff291077e16254f10f5bfe6a) Thanks [@evertiro](https://github.com/evertiro)! - Add styles for Rodent Report download button

- [#441](https://github.com/FuelRats/fuelrats.com/pull/441) [`001693d`](https://github.com/FuelRats/fuelrats.com/commit/001693da2fa272a45e76de825c0adb1d95d0a633) Thanks [@evertiro](https://github.com/evertiro)! - Fixed DWB sysinfo chips breaking on small screens
